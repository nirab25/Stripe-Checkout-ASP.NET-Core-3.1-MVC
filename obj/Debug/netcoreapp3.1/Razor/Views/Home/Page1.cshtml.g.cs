#pragma checksum "E:\Projects\Github\Stripe-Checkout-ASP.NET-Core-3.1-MVC\Views\Home\Page1.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ec9131812d3d061950346429781a371cc63d1fe2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ec9131812d3d061950346429781a371cc63d1fe2", @"/Views/Home/Page1.cshtml")]
...
<style>
      ...
      .input_value::-webkit-slider-thumb {
        -webkit-a");
            WriteLiteral(@"ppearance: none;
        appearance: none;
        background: #737373;
        border-radius: 50%;
        height: 25px;
...
<div class=""payment"">
    <div class=""div_01"">
        <div class=""inputRange"">
            <div class=""suggestedAmounts"">
                <but");
            WriteLiteral(@"ton class=""amt-btn"" data-val=""10"">$10</button>
                <button class=""amt-btn"" data-val=""20"">$20</button>
                <button class=""amt-btn"" data-val=""50"">$50</button>
                <button class=""amt-btn"" data-val=""100"">$100</button>
                <button class=""amt-btn"" data-val=""250"">$250</button>
            </div>
            <div class=""suggestedAmounts"">
                <button class=""amt-btn"" data-val=""500"">$500</button>
                <button class=""amt-btn"" data-val=""1000"">$1000</button>
                <button class=""amt-btn"" data-val=""2500"">$2500</button>
                <button class=""amt-btn"" data-val=""5000"">$5000</button>
                <button class=""amt-btn"" data-val=""0"">Other</button>
            </div>
        </div>
    </div>
    <div class=""div_02"">
        <label id=""div_02_label"" for=""inputAmt"">$</label>
        <input type=""text"" id=""inputAmt"" name=""inputAmt"">
        <button id=""btn"">Donate Now</button>
    </div>

    <!--div class=""div_02"">
");
            WriteLiteral(@"      <button id=""btn"">Pay $50.00</button>
    </div-->
...
<div class=""terms"">
    ...
    <p>
        ...
        stability and oversight in");
            WriteLiteral(@" the administration of the federal student
        ...
        of other state and federal rules and l");
            WriteLiteral(@"aws. Financial records are
...
<script>
  ...
  ");
    ...
    /*$("".amt-btn"").on(""click"", function () {
      // console.log(this.dataset.val);
      var v1 = parseFloat(this.dataset.val).toFixed(2);
      var v2 = this.dataset.val;
      if (v1) {
        $(""#btn"").html(""Pay $"" + v1);
        $(""#input_value"")
          .val(v2)
          .css({
            background:
              ""linear-gradient(to right, #737373 0%, #737373 "" +
              v2 +
              ""%, #bfbfbf "" +
              v2 +
              ""%, #bfbfbf 100%)"",
    ...
    btn.addEventListener(""");
            WriteLiteral(@"click"", async function () {
